    ...
    <div class="container-fluid px-4 py-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1 text-dark fw-bold">
                        <i class="bi bi-person-plus-fill text-primary"></i> Tambah Guru
                    </h1>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">
                    <i class="bi bi-clipboard-data"></i> Form Data Guru
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                                No. ID Guru <small class="text-muted">(Otomatis)</small>
                            </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('pendidikan') is-invalid @enderror"
                                name="pendidikan" value="{{ old('pendidikan') }}" placeholder="S1, S2, SMA, dll">
                            @error('pendidikan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
